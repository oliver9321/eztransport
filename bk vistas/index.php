                    ...
                    <div class="position-relative">
                        <div class="row">
                            <div class="col-lg-3 col-md-12">
                                <a id="logo" href="home.html" class="d-inline-block margin-tb-15px"><img src="assets/img/Imagen6.png" class="logoa" alt=""></a>
                                             ...
                                             <div class="col-sm-5 col-sm-offset-1">
                                           	...
                                           	<div class="col-sm-5">
		                                    	...
		                                    	<div class="form-group label-floating">
		                                        	...
		                                        	<input type="text" class="form-control" id="StockModifications" name="StockModifications" required="required">
		                                    	</div>
		                                	</div>
                                              	<div class="col-sm-10 col-sm-offset-1">
...
<!-- Mirrored from nilethemes.com/html/nile-logistics/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 20:21:30 GMT -->
</html>
<script>
