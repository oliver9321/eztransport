							...
							<div class="row">
								...
								<div class="col-lg-7 col-md-12 position-inherit">
									<ul id="menu-main" class="nav-menu float-xl-left text-lg-center link-padding-tb-25px dropdown-dark">
										...
										</li><li class=""><a href="service.php">Services</a></li>
													...
													<div class="table-title">
														<div class="row">
															...
															<div class="col-sm-4" style="text-align: right; ">
																<button type="button" class="btn btn-success " id="add-new" style="font-size: 8px;"><i style="font-size: 15px;margin-top: -3px; position: relative; top: 1px;" class="fa fa-plus"></i>
																	<h7><b>Add New</b> </h7>
																</button>
															</div>
														</div>
